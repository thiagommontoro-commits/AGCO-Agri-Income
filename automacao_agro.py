...
class AgroETL:
    ...
    def gerar_relatorio_html(self):
        ...
        cols_numericas = [c for c in df_exibicao.columns if c not in ['Produto / Cultura', coluna_var]]
        ...
        caminho_html = os.path.join(self.dir_relatorios, 'relatorio_agronegocio.html')
...
if __name__ == "__main__":
    ...
    PASTAS = {
        ...
        "rel": os.path.join(BASE_DIR, "outputs")
    }
